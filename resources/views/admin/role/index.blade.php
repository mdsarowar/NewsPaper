    ...
    <div class="p-6 flex flex-col items-center">
        ...
        <div class="mb-8 w-full max-w-4xl">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Manage Roles</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">View, edit, or delete roles</p>
                </div>
                <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
                    <a href="{{route('roles.create')}}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center"><i class="fas fa-plus mr-2"></i>Add Role</a>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @foreach($roles as $role)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{{ $role->name }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{{ $role->display_name }}</td>
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                            <a href="{{ route('roles.edit', $role->id) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Edit</a>
