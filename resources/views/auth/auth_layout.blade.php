...
<div class="glass-effect rounded-2xl p-8 w-full max-w-md shadow-2xl fade-in relative z-10">
    ...
    <!-- Registration Form -->
    <form class="space-y-6" action="#" method="POST" id="registrationForm">
        <!-- Full Name Field -->
        <div>
        ...
        <div class="text-center">
            ...
            <a href="#" class="text-white hover:text-white/80 text-sm font-semibold transition-colors duration-200">
                Sign in here
            </a>
        </div>
    </form>
