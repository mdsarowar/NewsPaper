...
<div class="glass-effect rounded-2xl p-8 w-full max-w-md shadow-2xl fade-in relative z-10">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-white/80">Sign in to your admin account</p>
    </div>
    ...
    <form class="space-y-6" action="{{route('login.store')}}" method="POST">
        ...
        <div class="text-center">
            ...
            <a href="{{route('register')}}" class="text-white hover:text-white/80 text-sm font-semibold transition-colors duration-200">
                Create one now'
            </a>
        </div>
    </form>
    ...
    <div class="mt-8 text-center">
        <p class="text-white/60 text-xs">
            ...
            <a href="#" class="text-white/80 hover:text-white transition-colors duration-200">Terms of Service</a>
            and
