...
@section('description', 'Browse all articles from our blog')
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl">
                ...
                <nav class="flex items-center gap-2 text-sm text-white/80 mb-4">
                    ...
                    <span>/</span>
                    <span class="text-white">All Articles</span>
                </nav>
                ...
                <p class="text-lg text-white/90 mb-6">
                    Explore all articles from our blog across all categories
                </p>
        ...
        <div class="container mx-auto px-4">
            <form method="GET" class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto flex-wrap">
                    <!-- Category Filter -->
                    <select name="category" class="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white">
                    ...
                    @if(request()->hasAny(['search', 'sort', 'category']))
                        <a href="{{ route('articles_all') }}" class="px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-lg transition">
                            Reset
                        </a>
                    @endif
                </div>
        ...
        <div class="container mx-auto px-4">
                            ...
                            <div class="relative h-56 overflow-hidden">
                                ...
                                <div class="absolute bottom-4 left-4">
                                    <a href="{{ route('category.show', $article->category->slug) }}"
                                       class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-full transition">
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <a href="{{ route('home') }}" class="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition">
                        Back to Home
                    </a>
                </div>
            @endif
        ...
        <section class="py-12 bg-white">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    @foreach($categories as $cat)
                        <a href="{{ route('articles_all', ['category' => $cat->slug]) }}"
                           class="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl hover:shadow-lg transition group">
                            <div class="text-center">
                                ...
                                <h3 class="font-bold text-gray-900 mb-1 group-hover:text-blue-600 transition text-sm">{{ $cat->name }}</h3>
                                <p class="text-xs text-gray-600">{{ $cat->articles_count }} Articles</p>
                            </div>
                        </a>
                    @endforeach
                </div>
